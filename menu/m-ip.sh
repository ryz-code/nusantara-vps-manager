...
APIGIT=$(cat /etc/nusantara/github/api)
EMAILGIT=$(cat /etc/nusantara/github/email)
USERGIT=$(cat /etc/nusantara/github/username)
...
if [[ -f /etc/nusantara/github/api && -f /etc/nusantara/github/email && /etc/nusantara/github/username ]]; then
   rec="OK"
else
    mkdir /etc/nusantara/github > /dev/null 2>&1
fi
...
sleep 2
echo "$EMAIL1" > /etc/nusantara/github/email
echo "$USERNAME1" > /etc/nusantara/github/username
echo "$API1" > /etc/nusantara/github/api
echo "ON" > /etc/nusantara/github/gitstat
clear
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
...
sleep 1
REQIP=$(curl -sS https://raw.githubusercontent.com/${USERGIT}/nusantara-vps-manager/autoscript/izin/ip | awk '{print $4}' | grep $daftar)
...
git clone https://github.com/${USERGIT}/izin-vps.git &> /dev/null
...
Reg Date    : $hariini
" 
echo "${TEXT}" >>/root/izin-vps/newuser 
echo "### $client $exp $daftar $isadmin" >>/root/izin-vps/ipvps 
git add .
git commit -m register &> /dev/null
git branch -M master &> /dev/null
git remote add origin https://github.com/${USERGIT}/izin-vps.git &> /dev/null
git push -f https://${APIGIT}@github.com/${USERGIT}/izin-vps.git &> /dev/null
sleep 1
clear
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
echo -e "$COLOR1│${NC} ${COLBG1}               • REGISTER IPVPS •              ${NC} $COLOR1│$NC"
...
function delipvps(){
clear
rm -rf /root/izin-vps &> /dev/null
git config --global user.email "${EMAILGIT}" &> /dev/null
git config --global user.name "${USERGIT}" &> /dev/null
git clone https://github.com/${USERGIT}/izin-vps.git &> /dev/null
cd /root/izin-vps/ &> /dev/null
rm -rf .git &> /dev/null
git init &> /dev/null
touch ipvps &> /dev/null
clear
...
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}"
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
grep -E "^### " "/root/izin-vps/ipvps" | cut -d ' ' -f 2-4 | nl -s '. '
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}" 
echo -e "$COLOR1┌────────────────────── BY ───────────────────────┐${NC}"
echo -e "$COLOR1│${NC}               • RYZ STORE VPN •                 $COLOR1│"
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}"
...
exp=$(grep -E "^### " "/root/izin-vps/ipvps" | cut -d ' ' -f 3 | sed -n "$nombor"p) #exp
ivps1=$(grep -E "^### " "/root/izin-vps/ipvps" | cut -d ' ' -f 4 | sed -n "$nombor"p) #ip
sed -i "s/### $name1 $exp $ivps1//g" /root/izin-vps/ipvps &> /dev/null
...
" 
echo "${TEXTD}" >>/root/izin-vps/delete_log  &> /dev/null
...
git config --global user.email "${EMAILGIT}" &> /dev/null
git config --global user.name "${USERGIT}" &> /dev/null
git clone https://github.com/${USERGIT}/izin-vps.git
cd /root/izin-vps/
rm -rf .git
git init
touch ipvps
...
NUMBER_OF_CLIENTS=$(grep -c -E "^### " "/root/izin-vps/ipvps")
...
ivps1=$(grep -E "^### " "/root/izin-vps/ipvps" | cut -d ' ' -f 4 | sed -n "${CLIENT_NUMBER}"p) #ip
...
sed -i "s/### $name1 $exp $ivps1/### $name1 $exp4 $ivps1/g" /root/izin-vps/ipvps
git add .
git commit -m renew
git branch -M master
git remote add origin https://github.com/${USERGIT}/izin-vps.git
git push -f https://${APIGIT}@github.com/${USERGIT}/izin-vps.git
clear
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
echo -e "$COLOR1│${NC} ${COLBG1}               • REGISTER IPVPS •              ${NC} $COLOR1│$NC"
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}"
...
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}"
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
grep -E "^### " "/root/izin-vps/ipvps" | cut -d ' ' -f 2 | nl -s '. '
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}" 
echo -e "$COLOR1┌────────────────────── BY ───────────────────────┐${NC}"
echo -e "$COLOR1│${NC}               • RYZ STORE VPN •                 $COLOR1│"
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}"
...
function resetipvps(){
clear
rm -f /etc/nusantara/github/email
rm -f /etc/nusantara/github/username
rm -f /etc/nusantara/github/api
rm -f /etc/nusantara/github/gitstat
echo "OFF" > /etc/nusantara/github/gitstat
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
...
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}"
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
GITREQ=/etc/nusantara/github/gitstat
if [ -f "$GITREQ" ]; then
    cekk="ok"
else 
    mkdir /etc/nusantara/github
    touch /etc/nusantara/github/gitstat
    echo "OFF" > /etc/nusantara/github/gitstat
fi

stst1=$(cat /etc/nusantara/github/gitstat)
if [ "$stst1" = "OFF" ]; then
clear
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
echo -e "$COLOR1│${NC} ${COLBG1}               • REGISTER IPVPS •              ${NC} $COLOR1│$NC"
...
stst=$(cat /etc/nusantara/github/gitstat)
if [ "$stst" = "ON" ]; then
APIOK="CEK API"
rex="viewapi"
else
