...
###########- COLOR CODE -##############
colornow=$(cat /etc/nusantara/nusantara/color.conf)
NC="\e[0m"
RED="\033[0;31m" 
...
01 | 1)
clear
echo "blue" >/etc/nusantara/theme/color.conf
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
...
02 | 2)
clear
echo "red" >/etc/nusantara/theme/color.conf
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
...
03 | 3)
clear
echo "yellow" >/etc/nusantara/theme/color.conf
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
...
04 | 4)
clear
echo "cyan" >/etc/nusantara/theme/color.conf
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
...
05 | 5)
clear
echo "green" >/etc/nusantara/theme/color.conf
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
...
06 | 6)
clear
echo "magenta" >/etc/nusantara/theme/color.conf
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
