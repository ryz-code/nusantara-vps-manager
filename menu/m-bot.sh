...
[[ ! -f /usr/bin/jq ]] && {
    ...
    wget -q --no-check-certificate "https://github.com/ryz-code/nusantara-vps-manager/autoscript/bot/jq-linux64" -O /usr/bin/jq
    chmod +x usr/bin/jq
}
...
wget -qO- https://raw.githubusercontent.com/ryz-code/autoscript-vps-manager/autoscript/bot/bot-api.sh >/etc/.maAsiss/.Shellbtsss
}
