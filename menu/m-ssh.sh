...
if [[ ! -z "${PID}" ]]; then
echo -e "$COLOR1====================================${NC}"
echo -e "$COLOR1${NC} ${COLBG1}        • NUSANTARA VPS MANAGER •              ${NC}"
echo -e "$COLOR1====================================${NC}"
echo ""
echo -e "$COLOR1◈─────⪧$NC ${COLBG1}IMPORTANT$NC ⪦──────◈$NC"
echo ""
echo -e "$COLOR1◈⪧$NC 🚫ㅤNO SPAM"
echo -e "$COLOR1◈⪧$NC ⚠️ㅤNO DDOS"
echo -e "$COLOR1◈⪧$NC 🎭ㅤNO Hacking"
echo -e "$COLOR1◈⪧$NC ⛔️ㅤNO Carding"
echo -e "$COLOR1◈⪧$NC 🙅‍♂️ㅤNO Torrent"
echo -e "$COLOR1◈⪧$NC ❌ㅤNO MultiLogin"
echo -e "$COLOR1◈⪧$NC 🤷‍♂️ㅤNO Illegal Activities"
echo ""
echo -e "$COLOR1◈─────⪧$NC ${COLBG1}SSH ACCOUNT$NC $COLOR1⪦─────◈$NC"
echo ""
...
echo ""
echo -e "$COLOR1◈──────⪧$NC ${COLBG1}PORTS$NC $COLOR1⪦───────◈$NC"
echo ""
...
echo -e "$COLOR1◈──────⪧$NC ${COLBG1}PAYLOAD$NC $COLOR1⪦───────◈$NC"
...
wget -q -O /usr/bin/proxy3.js "https://raw.githubusercontent.com/ryz-code/autoscript-vpn/master/ssh/proxy3.js"
cat <<EOF > /etc/systemd/system/sshws.service
[Unit]
Description=WSenabler
Documentation=https://RYZXD.MY.ID
...
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}"
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}" 
wget -q -O /usr/bin/ssh-wsenabler "https://raw.githubusercontent.com/ryz-code/autoscript-vpn/master/ssh/sshws-true.sh" && chmod +x /usr/bin/ssh-wsenabler
...
Login=nusantara`</dev/urandom tr -dc X-Z0-9 | head -c4`
hari="1"
Pass=1
...
echo -e "$COLOR1◈⪧$NC 🤷‍♂️ㅤNO Illegal Activities"
echo ""
echo -e "$COLOR1◈─────⪧$NC ${COLBG1}TRIAL SSH ACCOUNT$NC $COLOR1⪦─────◈$NC"
echo ""
echo -e "$COLOR1◈⪧$NC  IP         : $IP" 
echo -e "$COLOR1◈⪧$NC  Host       : $domen" 
echo -e "$COLOR1◈⪧$NC  Username   : $Login" 
...
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}"
echo -e "$COLOR1┌───────────────────────────────────────────────┐${NC}
echo -e "$COLOR1│$NC   ${COLOR1}[01]${NC} • ADD SSH         ${COLOR1}[05]${NC} • DELETE SSH${NC}    $COLOR1│$NC
echo -e "$COLOR1│$NC   ${COLOR1}[02]${NC} • TRIAL SSH       ${COLOR1}[06]${NC} • RENEW SSH${NC}     $COLOR1│$NC
echo -e "$COLOR1│$NC   ${COLOR1}[03]${NC} • USER ONLINE     ${COLOR1}[07]${NC} • USERS LIST${NC}    $COLOR1│$NC
echo -e "$COLOR1│$NC   ${COLOR1}[04]${NC} • ENABLE WS                            $COLOR1│$NC
