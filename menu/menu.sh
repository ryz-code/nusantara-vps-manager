...
Exp=$(curl -sS https://raw.githubusercontent.com/ryz-code/nusantara-vps-manager/autoscript/izin/ip | grep $MYIP | awk '{print $3}')
fi
export RED='\033[0;31m'
...
echo "IP=$host" > /var/lib/nusantara-vps/ip.conf
echo ""
...
sleep 2
wget -q -O /root/install_up.sh "https://raw.githubusercontent.com/ryz-code/nusantara-vps-manager/update/autoscript/install_up.sh" && chmod +x /root/install_up.sh
sleep 2
./install_up.sh
sleep 5
rm /root/install_up.sh
rm /opt/.ver
version_up=$( curl -sS https://raw.githubusercontent.com/ryz-code/nusantara-vps-manager/update/autoscript/version_up)
...
serverV=$( curl -sS https://raw.githubusercontent.com/ryz-code/nusantara-vps-manager/update/autoscript/version_up)
if [ "$Isadmin" = "ON" ]; then
